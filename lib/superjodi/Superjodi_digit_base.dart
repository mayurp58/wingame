...
class Sup_digit_base extends StatefulWidget {
  final String? title;
  final String? session;
  final int id;
  final String? date;
  const Sup_digit_base({Key? key, this.title, this.session, required this.id, this.date}) : super(key: key);

  @override
  State<Sup_digit_base> createState() => _Sup_digit_baseState();
}

class _Sup_digit_baseState extends State<Sup_digit_base> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            Sup_gameplay_header(id:widget.id.toString(),title: widget.title,type: "Digit Based Jodi",session: "",date: widget.date,),
            //////////////////////////////Heade Ends Here////////////////////////////
            Container(
              //height: ,
                          ...
                          onPressed: (){
                            ...
                            if (validateAndSave() && amount.text!="" && ((left_digit.text!="" && right_digit.text=="") || (left_digit.text=="" && right_digit.text!="")))
                            {
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => Sup_submit_bid(title: widget.title,session:widget.session,id: widget.id,date: widget.date,itemDetail: itemDetail,image: "digit_based_jodi.png",game_name: "Digit Jodi",total: total.toString(),))
