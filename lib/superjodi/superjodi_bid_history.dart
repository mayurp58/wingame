...
class Sup_bid_history extends StatefulWidget {
  const Sup_bid_history({Key? key}) : super(key: key);

  @override
  State<Sup_bid_history> createState() => _Sup_bid_historyState();
}

class _Sup_bid_historyState extends State<Sup_bid_history> {
  ...
  void get_bid_details() async {
    ...
    apiService
        .apicall({"str": encryp(json.encode(map))}, "ab_bid_history").then((value) {
