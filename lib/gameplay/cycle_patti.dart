...
class CyclePatti extends StatefulWidget {
  ...
  final int id;
  final String? date;
  const CyclePatti({Key? key, this.title, this.session, required this.id,required this.date}) : super(key: key);
...
class _CyclePattiState extends State<CyclePatti> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            GameplayHeader(id:widget.id.toString(),title: widget.title,type: "Cycle Patti",session: widget.session,date: widget.date,),
            //////////////////////////////Heade Ends Here////////////////////////////
            Container(
              //height: ,
  ...
  setdigits()
  {
    ...
    cycle[57] = {"157","257","357","457","557","578","579","570","457","577"};
