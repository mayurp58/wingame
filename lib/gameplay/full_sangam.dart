...
class FullSangam extends StatefulWidget {
  ...
  final int id;
  final String? date;
  const FullSangam({Key? key, this.title, this.session, required this.id,required this.date}) : super(key: key);
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            ...
            GameplayHeader(id:widget.id.toString(),title: widget.title,type: "Full Sangam",session: "",date: widget.date,),
            //////////////////////////////Heade Ends Here////////////////////////////
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      SubmitBid(title: widget.title,
                                        ...
                                        image: "full-sangam.png",
                                        game_name: "Full Sangam",
            ...
            Row(
              children: [
                ...
                ElevatedButton(
                    ...
                    onPressed: (){
                      if(validateAndSave()) {
                        var txt = controller.text + "-" + controller2.text;
                            ...
                            child: Autocomplete<String>(
                              ...
                              fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                                ...
                                return TextFormField(
                                  ...
                                  decoration: ThemeHelper().customInputDecoration('Open Panel',""),
                            ...
                            child: Autocomplete<String>(
                              ...
                              fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                                ...
                                return TextFormField(
                                  ...
                                  focusNode: focusNode,
                                  onEditingComplete: onEditingComplete,
                                  decoration: ThemeHelper().customInputDecoration('Close Panel',""),
                                  textAlign: TextAlign.center,
                                  keyboardType: TextInputType.number,
                                  //controller: left_digit,
                                  maxLength: 3,
