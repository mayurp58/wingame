...
class GroupJodi extends StatefulWidget {
  ...
  final int id;
  final String? date;
  const GroupJodi({Key? key, this.title, this.session, required this.id,required this.date}) : super(key: key);
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            ...
            GameplayHeader(id:widget.id.toString(),title: widget.title,type: "Group Jodi",session: "",date: widget.date,),
            //////////////////////////////Heade Ends Here////////////////////////////
            Container(
              //height: ,
                          ...
                          onPressed: (){
                            ...
                            if (validateAndSave() && amount.text!="" && jodidgt.text!="" )
                            {
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => SubmitBid(title: widget.title,session:widget.session,id: widget.id,date: widget.date,itemDetail: itemDetail,image: "group_jodi.png",game_name: "Group Jodi",total: total.toString(),))
