...
class StarlineDpMotor extends StatefulWidget {
  final String? title;
  final String? session;
  final int id;
  final String? date;
  const StarlineDpMotor({Key? key, this.title, this.session, required this.id,required this.date}) : super(key: key);

  @override
  State<StarlineDpMotor> createState() => _StarlineDpMotorState();
}

class _StarlineDpMotorState extends State<StarlineDpMotor> {
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            ...
            StarlineGameplayHeader(id:widget.id.toString(),title: widget.title,type: "DP Motor",session: widget.session,date: widget.date,),
            //////////////////////////////Heade Ends Here////////////////////////////
            Container(
              //height: ,
