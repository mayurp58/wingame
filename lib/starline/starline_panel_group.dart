...
class StarlinePanelGroup extends StatefulWidget {
  final String? title;
  final String? session;
  final int id;
  final String? date;
  const StarlinePanelGroup({Key? key, this.title, this.session, required this.id,required this.date}) : super(key: key);

  @override
  State<StarlinePanelGroup> createState() => _StarlinePanelGroupState();
}

class _StarlinePanelGroupState extends State<StarlinePanelGroup> {
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            ...
            StarlineGameplayHeader(id:widget.id.toString(),title: widget.title,type: "Family Panna",session: widget.session,date: widget.date,),
            //////////////////////////////Heade Ends Here////////////////////////////
            Container(
              //height: ,
