...
class StarlineSpMotor extends StatefulWidget {
  final String? title;
  final String? session;
  final int id;
  final String? date;
  const StarlineSpMotor({Key? key, this.title, this.session, required this.id,required this.date}) : super(key: key);

  @override
  State<StarlineSpMotor> createState() => _StarlineSpMotorState();
}

class _StarlineSpMotorState extends State<StarlineSpMotor> {
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            ...
            StarlineGameplayHeader(id:widget.id.toString(),title: widget.title,type: "SP Motor",session: widget.session,date: widget.date,),
            //////////////////////////////Heade Ends Here////////////////////////////
            Container(
              //height: ,
