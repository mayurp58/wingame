...
class SubmitStarlineBid extends StatefulWidget {
  final String? title;
  ...
  final String total;
  const SubmitStarlineBid({Key? key,this.title, this.session, required this.id,required this.date,required this.itemDetail,required this.image,required this.game_name,required this.total}) : super(key: key);

  @override
  State<SubmitStarlineBid> createState() => _SubmitStarlineBidState();
}

class _SubmitStarlineBidState extends State<SubmitStarlineBid> {
  ...
  Widget _uiSetup(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.title.toString()+ "-" + "Starline",
                          ...
                          ElevatedButton(
                              ...
                              onPressed: (){
                                ...
                                if (widget.itemDetail.length > 0) {
                                  ...
                                  apiService.apicall({"str": encryp(json.encode(map))}, "starline_add_bid").then((value) {
