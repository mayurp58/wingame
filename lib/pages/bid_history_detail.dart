...
class BidDetails extends StatefulWidget {
  ...
  const BidDetails({Key? key,required this.title,required this.prov_id}) : super(key: key);
...
class _BidDetailsState extends State<BidDetails> {
  ...
  void get_bid_details() async {
    ...
    Map<String, dynamic> map = {
      ...
      'prov_id': widget.prov_id,
    };
    APIService apiService = new APIService();
    apiService
        .apicall({"str": encryp(json.encode(map))}, "bid_history").then((value) {
                    ...
                    children: [
                      ...
                      SizedBox(height: 15,),
                        Row(
                          ...
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            GradientText(biddetails[index]["prov_name"] + " - " + biddetails[index]["game_brackets"] + " - " + biddetails[index]["game_session"].toUpperCase(),
